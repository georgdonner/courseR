...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { name: @subject.name, study_path: @subject.study_path } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { name: @subject.name, study_path: @subject.study_path } }
